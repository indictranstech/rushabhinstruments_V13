frappe.listview_settings["Material Request"] = {
	refresh:function(listview){
		listview.page.add_action_item(__("Create Purchase Order"), function() {
			const assets = listview.get_checked_items();
			var data = {purchase_order_data:assets};
			// var data = assets[0]
			var myJSON = JSON.stringify(data);
			frappe.call({
				method : "instrument.instrument.custom_instrument.material_request.material_request.create_bulk_po",
				freeze : true,
				args:{
					data : myJSON
				},
